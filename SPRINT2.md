...
### 1. Outer Planets System 🪐 [COMPLETED ✅]
...
#### Subtasks:
- [x] 1.1: Add Jupiter planet data to constants.js (orbital radius, period, size, color) ✅
- [x] 1.2: Add Saturn planet data with ring system parameters ✅
- [x] 1.3: Add Uranus planet data with tilted rotation axis ✅
- [x] 1.4: Add Neptune planet data ✅
- [x] 1.5: Implement Saturn ring geometry (THREE.RingGeometry or custom) ✅
- [x] 1.6: Update planets.js to support 8 planets (currently supports 4) ✅
- [x] 1.7: Add orbital paths for outer planets (much larger scale) ✅
- [x] 1.8: Implement camera zoom presets (inner system / outer system / full system) ✅
- [x] 1.9: Add labels for new planets ✅
- [x] 1.10: Update UI to register new clickable objects ✅
- [x] 1.11: Test performance with 8 planets + orbits ✅
- [x] 1.12: Optimize proportional sizes with tiered scaling system ✅
- [x] BONUS: Add dropdown selector for easy object selection ✅
- [x] BONUS: Create iconic ISS geometry (cylinder + solar panels) ✅
- [x] BONUS: Fix ISS orientation to stay parallel to Earth ✅
...
#### Acceptance Criteria:
- [x] All 8 planets visible and orbiting correctly ✅
- [x] Saturn has visible ring system ✅
- [x] Orbital periods accurate (Jupiter: 11.86 years, Saturn: 29.46 years) ✅
- [x] Camera can zoom to see full system or focus on inner/outer regions ✅
- [x] Performance remains smooth (60 FPS target on balanced settings) ✅
- [x] All planets clickable with click-to-focus ✅
- [x] Labels show correct distances from Sun and Earth ✅
- [x] Proportional planet sizes show realistic size relationships ✅
